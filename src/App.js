          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              <div>
                ...
                <p className="text-[10px] md:text-xs text-cyan-300">Sample Pack Library</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              {user && profile ? (
                <div className="flex items-center space-x-2">
                  ...
                  {profile.is_admin && (
                    <button
                      onClick={() => navigate('/feelzadmin')}
                      className="hidden md:flex items-center space-x-1 px-3 py-1.5 text-xs bg-purple-500/20 hover:bg-purple-500/30 rounded-lg transition border border-purple-500/30"
                      title="Admin Panel"
                    >
                      <span className="text-purple-300">⚙️ Admin</span>
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className="hidden md:flex items-center space-x-1 px-3 py-1.5 text-xs bg-cyan-500/20 hover:bg-cyan-500/30 rounded-lg transition"
                    title="Edit Profile"
                  >
                  ...
                  {/* User Greeting */}
                  <div className="flex items-center space-x-2">
                    <span className="text-xs text-cyan-300 hidden sm:inline">Hey, {profile.name}!</span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold rounded-lg transition flex items-center justify-center space-x-3 mb-3"
              >
              ...
              <button
                ...
                className="w-full py-2.5 bg-white/10 hover:bg-white/20 rounded-lg transition text-white"
              >
                Cancel
              </button>
            </motion.div>
