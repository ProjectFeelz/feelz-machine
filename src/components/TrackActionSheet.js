  ...
  const handleDownload = async () => {
          ...
          try {
                    ...
                    if (err.message === 'purchase_required') {
                                // Open the in-sheet purchase flow instead of showing a dead-end error
...
{track.is_downloadable && track.id && (
                   ...
                   >
                     ...
                     {downloading ? 'Downloading...' : effectivePrice > 0 ? `Buy & Download · $${effectivePrice.toFixed(2)}` : 'Download'}
</span>
    </div>
    </button>
{downloadError && (
