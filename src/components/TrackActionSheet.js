...
export default function TrackActionSheet({ track, artist, onClose }) {
  ...
  const isPreorder = track?.is_preorder === true;
    ...
    // Check if user has already pre-ordered (purchase row exists but file not yet released)
                ...
                window.paypal.Buttons({
                        ...
                        onApprove: async (data) => {
                                  try {
                                    ...
                                    // If pre-order and not yet released: show pre-order confirmed, don't download yet
                                    ...
                                    // Otherwise trigger the download immediately
                                    setTimeout(async () => {
                                                  try {
...
{track.is_downloadable && track.id && (
                  <>
{/* Already pre-ordered — show locked state */}
