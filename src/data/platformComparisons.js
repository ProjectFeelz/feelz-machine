...
const platformComparisons = {
  spotify: {
    slug: 'spotify',
    name: 'Spotify',
    metaTitle: 'Spotify Alternative for Independent Artists: Feelz Machine vs Spotify',
    ...
    whatFMDoesDifferently: [
      { title: 'Sales paid straight to your PayPal', desc: 'When a fan buys your music, the money goes directly into your own PayPal the moment they pay. No commission, no payout threshold, no waiting on a monthly statement. The buyer covers the processing fee, so you get the price you set.' },
  ...
  soundcloud: {
    slug: 'soundcloud',
    name: 'SoundCloud',
    metaTitle: 'SoundCloud Alternative for Independent Artists: Feelz Machine vs SoundCloud',
  ...
  bandcamp: {
    slug: 'bandcamp',
    name: 'Bandcamp',
    metaTitle: 'Bandcamp Alternative: Sell Music Direct to Fans | Feelz Machine vs Bandcamp',
  ...
  'apple-music': {
    slug: 'apple-music',
    name: 'Apple Music',
    metaTitle: 'Apple Music Alternative for Independent Artists: Feelz Machine vs Apple Music',
