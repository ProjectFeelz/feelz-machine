...
import {
    ...
    Download, Apple, Play, ExternalLink
} from 'lucide-react';
...
{apkUploadedUrl && (
              <div className="flex items-center justify-between p-3 bg-green-500/10 rounded-xl border border-green-500/20">
               ...
               <a href={apkUploadedUrl} download
                 className="flex items-center space-x-1.5 ml-3 px-3 py-1.5 bg-green-500 text-black rounded-lg text-xs font-semibold">
...
{/* Link Button */}
          <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-3 space-y-2">
                        <p className="text-[11px] text-white/30 flex items-center space-x-1.5">
                          ...
                          <span>Link Button (optional) — leads users off-site</span>
            </p>
            <input
              type="text"
              value={linkButtonLabel}
              onChange={e => setLinkButtonLabel(e.target.value)}
                              placeholder="Button label  (e.g. Learn More, Buy Tickets)"
