    ...
    <div className="pt-10 md:pt-0 pb-4 px-6 md:px-0">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={refresh}
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/[0.05] transition active:scale-90"
          >
      ...
      <div className="flex space-x-2 mb-4">
        <button
          ...
          className={`px-4 py-1.5 rounded-lg text-xs font-medium transition ${
            feedFilter === 'all' ? 'bg-white/10 text-white' : 'text-white/30 hover:text-white/50'
          }`}
        >
          All
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-lg text-xs font-medium transition ${
            feedFilter === 'following' ? 'bg-white/10 text-white' : 'text-white/30 hover:text-white/50'
          }`}
        >
          Following
        </button>
        <button
          ...
          className={`flex items-center space-x-1 px-4 py-1.5 rounded-lg text-xs font-medium transition ${
            feedFilter === 'trending' ? 'bg-white/10 text-white' : 'text-white/30 hover:text-white/50'
          }`}
        >
